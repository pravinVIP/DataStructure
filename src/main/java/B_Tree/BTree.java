...
public static void main(String[] args) {
 ...
 BTree b = new BTree(3);
 System.out.println("Inserting values 8");
 b.Insert(8);
 b.Show();
 System.out.println();
 System.out.println("Inserting values 9");
 b.Insert(9);
 b.Show();
 System.out.println();
 System.out.println("Inserting values 10");
 b.Insert(10);
 b.Show();
 System.out.println();
 System.out.println("Inserting values 11");
 b.Insert(11);
 b.Show();
 System.out.println();
 System.out.println("Inserting values 15");
 b.Insert(15);
 b.Show();
 System.out.println();
 System.out.println("Inserting values 20");
 b.Insert(20);
 b.Show();
 System.out.println();
 System.out.println("Inserting values 17");
 b.Insert(17);
